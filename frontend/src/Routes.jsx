  ...
  return (
    <AnimatePresence mode="wait">
      <RouterRoutes location={location} key={location.pathname}>
        ...
        <Route path="/court-schedule-management" element={<PageTransition><CourtScheduleManagement /></PageTransition>} />
        <Route path="/futsal-owner-dashboard" element={<PageTransition><FutsalOwnerDashboard /></PageTransition>} />
        <Route path="/futsal-management" element={<PageTransition><FutsalManagement /></PageTransition>} />
        <Route path="/futsal-management/new" element={<PageTransition><FutsalManagement /></PageTransition>} />
        <Route path="/futsal-management/edit/:id" element={<PageTransition><FutsalManagement /></PageTransition>} />
        <Route path="/futsal-management/:id" element={<PageTransition><FutsalManagement /></PageTransition>} />
        <Route path="/futsal-owner-profile" element={<PageTransition><FutsalOwnerProfile /></PageTransition>} />
        <Route path="/court-management" element={<PageTransition><CourtManagement /></PageTransition>} />
